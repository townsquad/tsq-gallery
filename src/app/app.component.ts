...
export class AppComponent {
  ...
  files: TSqGalleryFileModel[] = [
    ...
    // tslint:disable-next-line:max-line-length
    {name: 'file_06.png', type: 'image', displayUrl: './assets/images/06.png', downloadUrl: 'https://cdn.vox-cdn.com/thumbor/GNXFfWIVnp-51ld-aYdKv-JzxRI=/0x0:637x355/1820x1213/filters:focal(269x128:369x228):format(webp)/cdn.vox-cdn.com/uploads/chorus_image/image/51105501/adventuretime.0.png'},
    // tslint:disable-next-line:max-line-length
