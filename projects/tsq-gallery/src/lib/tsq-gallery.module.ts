...
import {faCloudDownloadAlt, faSearchMinus, faSearchPlus, faUndoAlt, faRedoAlt, faTimesCircle} from '@fortawesome/free-solid-svg-icons';
...
export class TSqGalleryModule {
  constructor(library: FaIconLibrary) {
    library.addIcons(faCloudDownloadAlt, faSearchMinus, faSearchPlus, faUndoAlt, faRedoAlt, faTimesCircle);
  }
}
